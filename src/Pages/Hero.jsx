...
export default function Hero() {
    return(
        ...
        <div className="bg-black relative text-white h-screen md:h-[124vh]"
            id="hero-section">
            <div className="flex flex-col text-4xl font-semibold font-sans py-2 leading-relaxed px-10 absolute top-80 w-1/2">
            ...
            <div className="flex text-4xl flex-col md:flex-row md:w-[99vw] p-0 m-0 absolute bottom-5">
