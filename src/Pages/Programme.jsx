    ...
    return(
        ...
        <div className="bg-black">
            <div className="flex flex-col items-center justify-center ">
                ...
                className="grid p-5 text-white text-center uppercase grid-cols-4 gap-14 md:gap-36">
                <div className=""><img src="src/assets/portal/stem.jpg" alt="" /></div>
                <div className=""><img src="src/assets/portal/stem.jpg" alt="" /></div>
                <div className=""><img src="src/assets/portal/stem.jpg" alt="" /></div>
                <div className=""><img src="src/assets/portal/stem.jpg" alt="" /></div>
                ...
                <div 
                className="text-white mt-40 font-mono flex flex-col justify-center items-center ">
                ...
                <div className="w-[80vw] mx-auto px-0 overflow-hidden "><SwipeCarousel/>
                <div className="text-xl z-20 flex justify-end items-end text-blue-400 hover:text-blue-500 transition-all underline  w-auto"><a href="">Read more here</a></div></div>
            </div>
        </div>
        </>
    )
