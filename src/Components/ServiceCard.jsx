...
return (
    <>
    <div className="px-2 w-[240] transition-all duration-75 ease-in-out border-blue-950 border-[1px] hover:scale-[1.01] hover:border-blue-900 h-96 flex justify-center items-center flex-col">
